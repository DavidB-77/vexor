// ─────────────────────────────────────────────────────────────────────────────
// Vexor BN254 base-field (Fp) Montgomery arithmetic — the field-reduction layer.
//
// This file is the ONE component of the Vexor pure-Zig BN254 stack that is NOT a
// clean re-implementation: it is the fiat-crypto formally-verified word-by-word
// Montgomery reduction for the BN254 base field prime
//   p = 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47
// carried as-is on purpose. Bit-identical modular reduction is mandatory for
// consensus (one wrong bit forks bank_hash), and the canonical, machine-checked
// way to get it is the fiat-crypto artifact — NOT a hand-rolled "cleaner"
// reduction. Everything ABOVE this layer (Fp wrapper, Fp2/Fp6/Fp12 tower, G1/G2,
// Miller loop, final exp, serialization) is Vexor's own implementation.
//
// Provenance: fiat-crypto (https://github.com/mit-plv/fiat-crypto), MIT/Apache-2.0
// /BSD, machine-generated Coq extraction. The same generator output is used by
// Syndica's Sig (Apache-2.0) and by other Solana clients; this is a mathematical
// artifact, identical regardless of who runs the extractor. Credited in
// src/vex_crypto/NOTICE. Verbatim generator banner retained below.
// ─────────────────────────────────────────────────────────────────────────────
