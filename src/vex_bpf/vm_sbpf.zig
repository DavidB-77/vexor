...
pub const Version = enum(u32) {
    ...
    pub fn dynamicStackFrames(v: Version) bool {
        return v.gte(.v1);
    }
    pub fn pqrArithmetic(v: Version) bool {
        return v.gte(.v2);
    }
    pub fn swappedSubImm(v: Version) bool {
        return v.gte(.v2);
    }
    pub fn disableLddw(v: Version) bool {
        return v.gte(.v2);
    }
    pub fn callRegUsesSrc(v: Version) bool {
        return v.gte(.v2);
    }
    pub fn disableLe(v: Version) bool {
        return v.gte(.v2);
    }
    pub fn staticSyscalls(v: Version) bool {
        return v.gte(.v3);
    }
    pub fn lowerBytecodeVaddr(v: Version) bool {
        return v.gte(.v3);
    }
    pub fn rejectRodataStackOverlap(v: Version) bool {
        return v != .v0;
    }
    pub fn enableElfVaddr(v: Version) bool {
        return v != .v0;
    }
