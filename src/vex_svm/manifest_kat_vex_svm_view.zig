...
// `@import("vex_svm").blockhash_queue.FeeRateGovernor`. fix105's OWN vex_svm
...
// this ONE test target only (mirrors fix105's own precedent device for the
...
// (never fix105, never this tree) BEFORE wiring — confirmed this resolves
