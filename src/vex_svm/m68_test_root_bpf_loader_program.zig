...
//! as they do inside origin-tree's `vex_svm` module (rooted at src/vex_svm/root.zig).
...
//! origin-tree failures (module-46) do NOT run here — the gate is GREEN 2/2 and still
