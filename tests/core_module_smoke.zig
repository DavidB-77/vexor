...
//!
//! the internal tree has no dedicated test target covering config.zig / keypair.zig /
...
//! parse, base58 round-trip) still run where the internal tree runs them; this is a
