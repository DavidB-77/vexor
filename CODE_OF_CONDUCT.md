...
reported to the maintainers by the channel described in
[`SECURITY.md`](./SECURITY.md) for sensitive matters, or via a GitHub issue
for non-sensitive matters. All complaints will be reviewed and investigated
promptly and fairly.
